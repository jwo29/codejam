module.exports = {
    ...
    return `
      ...
      <body>
          <header>
              <div class="logo">
                  <h1><a href="/" style="text-decoration: none">CodeJam</a></h1>
              </div>
          </header>
          ...
          <nav>
              <div>
                  <ul>
                      ...
                      <li><a href="/study" style="text-decoration: none">Study</a></li>
                  </ul>
              </div>
          </nav>
      ...
      while(i < studyList.length){
        list = list + `<li><a href="/study/${studyList[i].title}" style="text-decoration: none">
